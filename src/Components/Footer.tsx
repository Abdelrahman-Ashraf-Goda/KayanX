    ...
    <div className="row">
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          <a href="#" className="contact-box__info--title">+20 1026956499</a>
          <p className="contact-box__info--subtitle">  Sun-Fri 9am-6pm</p>
        </div>
      </div>  
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        <div className="contact-box__icon">
      ...
      <div className="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
        ...
        <div className="contact-box__info">
          <a href="#" className="contact-box__info--title">Egypt/Cairo</a>
    ...
    <div className="container">
      <div className="row text-center text-white">
        <div className="col-12">
          <div className="footer-bottom__copyright">&COPY; Copyright 2021 <a href="#">Company</a> | Created by <a href="#/" target="_blank">KayanX</a>
            <br/><br/>
